...
class="w-full px-4 py-3 pr-12 rounded-xl bg-white/10 text-white"
placeholder="Password">

<button type="button"
onclick="togglePassword('login_password', 'icon_login')"
class="absolute right-4 top-3 text-slate-400">

<svg id="icon_login" xmlns="http://www.w3.org/2000/svg"
...
3.228l3.65 3.65m7.894 7.894L21 21m-3.228-3.228
l-3.65-3.65m0 0a3 3 0 10-4.243-4.243m4.242
4.242L9.88 9.88"/>
</svg>
